...
var JustLog, MIN_ROTATE_MS, colors, create, cwd, debug, defaultLogFile, error, events, fs, getHttpMsg, info, k, levels, middleware, mkdirp, moment, os, path, pattern, timeout, util, v, warn, _ref,
...
middleware = function(options, cb) {
  ...
  return function(req, resp, next) {
    ...
    resp.end = function(chunk, encoding) {
      ...
      return log.info(getHttpMsg(req, resp));
    };
    return next();
  };
};
